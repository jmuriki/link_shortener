...
## Запуск
После установки всего вышеперечисленного, находясь в директории проекта, откройте с помощью python3 файл main.py, введя через пробел ссылку, которую хотите сократить:
